1.  **How many students will share a room?**
...
2. **Is there any robotics group in campus?What are the Extracurricular
Clubs on campus?**

  No currently there is no robotics club in campus.But we have multiple
  other clubs like the Magazine Club, Zense , Comic Club,
    -   Zense: http://zense.co.in/
    -   Magazine: https://iiitbmagazine.wordpress.com/
    -   Aikyam:
...
3.  **How's the internet facility at IIIT Bangalore?**
...
4.  **Are there any Lawn-Tennis facilities around the campus to join and
    play as an outsider?**

  There are multiple lawn tennis academies near the campus, which one can
  join.

5.  **How many months vacation do students generally get?**
...
7.  **What is the criteria for scholarship at IIITB and what costs does
    it cover?**
...
1.  **Are there any arrangements for Non-Vegetarian students in the
    mess?**
...
1.  **Is a laptop required during the 1st year?**
...
1.  **Is the curriculum for ECE and CSE same for the first 4
    semesters?**
...
1.  **Which mobile service provider provides the best connectivity in
  ...
  ,there are generally no issues regarding mobile networks. So any network
  would be okay. There are also shops nearby for sim cards and mobile
  repair.

1.  **What is the system in IIITB for washing cloths (students)?**
...
1.  **Are there any hotels nearby or will the accommodations be
...
1.  **What should 1st year students bring such a Mattress, type of shoes
...
1.  **What is the last date to apply for a 100% refund at IIIT
    Bangalore?**

  Please call the administration for the above information.The office
  hours are 10 am to 5 pm with a lunch break in between from 12-2 am.(on
  weekdays)
...
1.  **Will the students who were offered ECE in the first list, be given
...
1.  **Is a branch change possible after admission?**

  No branch change is possible after admission.

1.  **What are the Fests held in IIITB?**
...
1.  **What have been the placements of students from IIITB?**
...
1.  **Does a 5 year course put me at a disadvantage for pursuing M.S
...
1.  **What is the infrastructure of IIITB like?**
...
1.  **Which degree will I be rewarded on graduation?**
...
6. **Is there any SC/ST/BC, women, physically challenged etc. quota for
IIIT admissions?**
...
11. **IIIT fee is higher than the fee at IITs or NITs. Why?**
...
13. **Is there a hostel facility on campus? What about the other
facilities?**

  Yes, Both men and women hostel facility is provided by the college.
  IIITB does not have any concept of “day-students” i.e. hostel stay is
...
14. **What are opening and closing JEE (Main) Marks in 2015 (branch
wise)?**
